...
public class StaffRegistration extends JFrame implements ChangeListener {
   ...
   public List<DoctorAppointment> selectList(String doctor) {
	   ...
	   try {
		...
		stmt = conn.prepareStatement("SELECT * FROM project_test.appointment where doctor = ?;");
   ...
   public void doctorSchedule(List<DoctorAppointment> list2) {
	    ...
	    for (DoctorAppointment appointment : list2) {
	        Object[] rowData = {
	                appointment.getBacknumber(),
	                appointment.getPlayerName(),
	                appointment.getDate(),
	                appointment.getTime(),
   ...
   public void displayDoctorSchedule() {
	    ...
	    try {
	        ...
	        // Prepare the SQL query to retrieve appointments for the selected date and doctor
   ...
   public StaffRegistration() {
       ...
       tableModel = new DefaultTableModel(
           new Object[][]{},
           new String[]{"\uB4F1\uBC88\uD638", "\uC120\uC218\uC774\uB984", "\uB0A0\uC9DC", "\uC2DC\uAC04", "\uBCD1\uBA85", "\uB2F4\uB2F9\uC758\uC0AC"}
       );
       ...
       comboBox.setBounds(869, 10, 98, 21);
       two.add(comboBox);
       box();
       ...
       lblNewLabel_1.setBounds(828, 13, 29, 15);
       ...
       comboBox_1.addItemListener(new ItemListener() {
		...
		public void itemStateChanged(ItemEvent e) {
			...
			System.out.println("값이 변경됨: " + e.getItem());
		}
	});
       ...
       textField.setBounds(93, 328, 116, 21);
       two.add(textField);
       ...
       textField_1.setBounds(290, 328, 116, 21);
       two.add(textField_1);
       ...
       JLabel lblNewLabel_8 = new JLabel("병명");
       lblNewLabel_8.setBounds(52, 379, 29, 15);
       two.add(lblNewLabel_8);

       textField_3 = new JTextField();
       textField_3.setBounds(93, 376, 283, 21);
       two.add(textField_3);
       textField_3.setColumns(10);

       JButton btnNewButton = new JButton("예약");
       btnNewButton.setBounds(843, 367, 124, 38);
       ...
       textField_4.setBounds(669, 328, 116, 21);
       two.add(textField_4);
